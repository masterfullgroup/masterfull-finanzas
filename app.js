...
const META = {
  ...
  cuentas:{title:'Cuentas',eye:'TU DINERO DISPONIBLE',singular:'cuenta'}, tarjetas:{title:'Tarjetas',eye:'CRÉDITO Y PAGOS',singular:'tarjeta'},
...
const state={page:'resumen',user:null,data:{},demo:false,editing:null}; let sb=null, authMode='login';
